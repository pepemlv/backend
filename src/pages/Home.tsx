...
function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: "Parcourez notre catalogue diversifié"
    },
    {
    ...
    {
      title: "Profitez",
      description: "Regardez votre contenu où et quand vous voulez"
    }
  ];
    ...
    <section className="py-16">
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Découvrez du contenu pour tous les goûts</p>
        </div>
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">
            Rejoignez PMStreaming aujourd’hui
          </h2>
